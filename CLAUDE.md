...
- **Rev 6 / V6 (current, ordering):** V5 electrically unchanged; power connectors J9/J13/J14 moved to the **top edge** for better console power routing, power runs upsized to 0.75–1.0mm. Gerbers `ti99-kb-adapter_r6.zip`, DRC 0/0, netlist re-verified.
